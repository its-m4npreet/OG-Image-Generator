...
export const templates = [
  ...
  },
  {
    ...
    name: "CTA Landing",
    category: "Social Media",
    tag: "FOR BUILDERS & CREATORS",
    istag: true,
    gradient: "from-primary/40 to-primary/5",
    title: "Stop Sharing Links With Boring Previews",
    subtitle: "Make polished OG images for blogs, products, portfolios, and launches — fast.",
    titleColor: "#FFFFFF",
  ...
  },
  {
    ...
    name: "Developer Blog",
    category: "blog",
    tag: "Code, Build, Repeat",
    istag: true,
    gradient: "from-primary/40 to-primary/5",
    pattern: 0,
    title: "Developer Blog",
    subtitle: "Practical lessons from web development, tools, and real-world projects.",
    titleColor: "#000000ff",
    subtitleColor: "#161717",
    titleSize: 54,
    hasImage: true,
    hasLogo: false,
    hasAuthor: false,
