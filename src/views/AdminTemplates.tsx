...
const AdminTemplates = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert("Invalid JSON in Metadata field. Please use valid JSON format.");
      return;
    }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground ml-12">Create and manage OG image templates</p>
          </div>
          <Button
            variant="default"
            onClick={() => {
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-muted-foreground mt-1">Valid JSON object (use {} for empty)</p>
            </div>
          </div>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} disabled={isSaving}>
              {isSaving ? "Saving..." : editingId ? "Update" : "Create"} Template
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
