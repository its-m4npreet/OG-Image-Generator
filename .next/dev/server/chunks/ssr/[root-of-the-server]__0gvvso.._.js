    ...
    callbacks: {
        ...
        async session ({ session, user }) {
            try {
                ...
                const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$postgres$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["pool"].query("SELECT role FROM users WHERE id = $1", [
                    user.id
                ]);
